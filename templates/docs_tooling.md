...
| **ty** | Static type checker for Python (Astral). | [Documentation](https://docs.astral.sh/ty/). Replaces mypy in this project. |
...
| **CodeRabbit** | Automated code review on PRs. | [CodeRabbit app](https://github.com/apps/coderabbit). See the section *Working with CodeRabbit* in the {doc}`contributing` guide. |
